...
describe('login functionality', () => {
    beforeEach(() => {
        cy.visit('/login')
        cy.get('#email').should('be.visible').type('oatup2018@yahoo.com')
    ...
    it('allows teacher functionality', () => {
        ...
        cy.get('body').should('contain.text', 'Welcome to the new Hilger Parent Portal')
        cy.get('body').should('not.contain.text', 'You currently have an outstanding balance')
        cy.get('[data-action="view-my-students"]').click()
        cy.get('body').should('contain.text', 'View Grades')
        cy.get('[data-action="view-grades"]').first().click()
