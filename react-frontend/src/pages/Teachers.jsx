...
import { pageOffset as pageOffsetAtom, pageSize as pageSizeAtom, searchTerm as searchTermAtom, students as studentAtom, impersonateUser as impersonateUserAtom } from "../atom"
...
const Teachers = () => {
  ...
  const [_, deleteTeacher] = useDeleteTeacherMutation()
  ...
  useEffect(() => {
    if (studentData && studentData.data) {
      setStudents(studentData.data.users)
          ...
          <ImpersonateUserBanner />
            ...
            <Stack spacing={{ base: "8", lg: "6" }}>
              ...
              <Stack spacing="5">
                ...
                <Box overflowX="auto">
                  <TeacherTable studentProp={students} columns={["Name", "Email"]}/>
                </Box>
                <Box px={{ base: "4", md: "6" }} pb="5">
                  <HStack spacing="3" justify="space-between">
                    {!isMobile && students && (
                      <Text color="muted" fontSize="sm">
                        Showing {pageOffset + 1} to {pageOffset + pageSize} of {students.length|| null} results
                      </Text>
                    )}
